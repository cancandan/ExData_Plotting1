...
png(file="plot4.png")
par(mfrow=c(2,2))
plot(part$Time, part$Global_active_power, type="l", xlab="", ylab="Global Active Power")
plot(part$Time, part$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(part$Time, part$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()